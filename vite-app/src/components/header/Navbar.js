            ...
            <Toolbar>
                ...
                <FlexRow color={theme.palette.neutral[0]} gap={.5} >
                    ...
                    {(!isMobileScreen && !user?.role) && (
                        <>
                            <Button component={Link} to="/login" startIcon={<LoginIcon />} sx={{
                            ...
                            <StyledBtn component={Link} to="/signup" startIcon={<img src='./assets/beriln.svg' style={{ maxWidth: '30px' }} />}>انشاء حساب</StyledBtn>
                        </>
                    )}
