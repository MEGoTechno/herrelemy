        ...
        <>
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    background: `linear-gradient(to right,  ${theme.palette.secondary.light}  , rgba(0,0 ,0,0) 10%)`, opacity: .9 //linear-gradient(to left, ${theme.palette.primary.light} 30%, ${theme.palette.primary.dark} 75%) `linear-gradient(45deg,transparent 42%,#9400ff 42%)`
                }} />
